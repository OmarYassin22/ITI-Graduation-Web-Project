  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="my-20">
        ...
        <div className="text-white grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5">
          {courses.slice(0, 6).map((course) => (
            <div
              key={course.id}
              onClick={() => router.push(`/allcourses/${course.id}`)}
            ...
            >
              <div className="absolute top-0 left-0 opacity-50 h-full w-full bg-slate-900 rounded-xl"></div>
